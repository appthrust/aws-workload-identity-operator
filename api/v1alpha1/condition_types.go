...
const (
	...
	ReasonACKResourceIdentifierPending    = "ACKResourceIdentifierPending"
	...
	ReasonInventoryAmbiguous              = "InventoryAmbiguous"
	...
	ReasonRemoteNamespaceBootstrapPending = "RemoteNamespaceBootstrapPending"
...
func AllReasons() []string {
	return []string{
		...
		ReasonRemoteNamespaceBootstrapPending,
