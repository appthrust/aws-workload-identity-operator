...
// SelfHostedTrustPolicy renders an IRSA trust policy for the self-hosted issuer.
func SelfHostedTrustPolicy(issuerHostPath, oidcProviderARN string, sa identityv1.ServiceAccountSubject) (string, error) {
	doc := policyDocument{
		Version: "2012-10-17",
