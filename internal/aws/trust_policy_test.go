...
func TestSelfHostedTrustPolicyContainsAudAndSub(t *testing.T) {
	policy, err := SelfHostedTrustPolicy("bucket.s3.ap-northeast-1.amazonaws.com", "arn:aws:iam::123456789012:oidc-provider/bucket", identityv1.ServiceAccountSubject{Namespace: "kube-system", Name: "controller"})
	if err != nil {
		t.Fatal(err)
	}
