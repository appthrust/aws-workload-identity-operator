...
const (
	...
	selfHostedRoleARNAnnotation         = remoteirsa.ServiceAccountRoleARNAnnotation
	selfHostedAudienceAnnotation        = remoteirsa.ServiceAccountAudienceAnnotation
	selfHostedRegionalSTSAnnotation     = remoteirsa.ServiceAccountRegionalSTSAnnotation
	selfHostedTokenExpirationAnnotation = remoteirsa.ServiceAccountTokenExpirationAnnotation
...
func renderSelfHostedServiceAccountAnnotations(roleARN string) map[string]string {
	...
	return map[string]string{
		...
		selfHostedAudienceAnnotation:        remoteirsa.STSAudience,
