...
func (r *AWSServiceAccountRoleReconciler) reconcileGeneratedPolicy(ctx context.Context, log logr.Logger, role *identityv1.AWSServiceAccountRole, delivery identityv1.DeliveryType, policyARNs []string) ([]string, error) {
	if role.Spec.PolicyDocument == nil || len(role.Spec.PolicyDocument.Statement) == 0 {
		...
		if err := r.deleteRoleChildIfOwned(ctx, log, role, policy); err != nil {
...
func (r *AWSServiceAccountRoleReconciler) reconcileDelete(ctx context.Context, role *identityv1.AWSServiceAccountRole) error {
	...
	for _, child := range children {
		if err := r.deleteRoleChildIfOwned(ctx, log, role, child); err != nil {
...
func (r *AWSServiceAccountRoleReconciler) deleteRoleChildIfOwned(ctx context.Context, log logr.Logger, role *identityv1.AWSServiceAccountRole, child client.Object) error {
...
func (r *AWSServiceAccountRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if hasMapping(mgr, eksv1alpha1.GroupVersion.WithKind(ackChildKindPodIdentityAssociation)) {
...
func (r *AWSServiceAccountRoleReconciler) rolesForClusterProfile(ctx context.Context, obj client.Object) []reconcile.Request {
	...
	return requestsForList(ctx, log, r.Client, &identityv1.AWSServiceAccountRoleList{}, client.InNamespace(namespace))
}
