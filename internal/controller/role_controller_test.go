...
// the CR-03 regression test for the steady-state prune branch in
...
func TestRoleReconcileNormalIAMRoleApplyErrorPreservesACKResources(t *testing.T) {
	...
	role.Spec.PolicyDocument = &identityv1.AWSIAMPolicyDocument{
		Version: "2012-10-17",
		Statement: []identityv1.AWSIAMPolicyStatement{
			{Raw: []byte(`{"Effect":"Allow","Action":["s3:GetObject"],"Resource":"*"}`)},
		},
	}
...
// Regression: STATUS-01 — when remote annotation cleanup fails because the
...
// Regression: STATUS-01 — once cleanup succeeds, reconcileDelete must
...
// TestRoleReconcileDeleteRemovesOwnedACKChildren is the LC-02 regression test
...
// TestRoleReconcileDeleteSkipsACKChildrenOwnedByDifferentRole is the LC-02
...
// TestRoleReconcileDeleteSkipsACKChildrenWithoutControllerRef is the LC-02
