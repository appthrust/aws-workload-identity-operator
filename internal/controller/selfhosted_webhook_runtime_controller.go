...
func ensureRemoteNamespace(ctx context.Context, c client.Client, name string) (controllerutil.OperationResult, error) {
	...
	if err == nil {
		if !isManagedWebhookRuntimeObject(ns) {
		...
		if apiequality.Semantic.DeepEqual(before.Labels, ns.Labels) {
			return controllerutil.OperationResultNone, nil
		}

		if err := c.Update(ctx, ns); err != nil {
			return controllerutil.OperationResultNone, fmt.Errorf("update remote Namespace %q labels: %w", name, err)
		}
	...
	if !apierrors.IsNotFound(err) {
		return controllerutil.OperationResultNone, fmt.Errorf("get remote Namespace %q: %w", name, err)
	}
	...
	if err := c.Create(ctx, ns); err != nil {
		...
		return controllerutil.OperationResultNone, fmt.Errorf("create remote Namespace %q: %w", name, err)
	}
...
func ensureRemoteServiceAccount(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteRole(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteRoleBinding(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteClusterRole(ctx context.Context, c client.Client, _ string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteClusterRoleBinding(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteService(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner) (controllerutil.OperationResult, error) {
...
func ensureRemoteMutatingWebhookConfiguration(ctx context.Context, c client.Client, namespace string, _ webhookRuntimeOwner, caBundle []byte) (*admissionregistrationv1.MutatingWebhookConfiguration, controllerutil.OperationResult, error) {
	path := "/mutate"
...
func ensureRemoteDeployment(ctx context.Context, c client.Client, namespace, image string, _ webhookRuntimeOwner, certFingerprint string) (*appsv1.Deployment, controllerutil.OperationResult, error) {
...
func deleteRemoteWebhookRuntime(ctx context.Context, c client.Client, namespace string) error {
	...
	for _, obj := range deletes {
		if err := deleteManagedRemoteWebhookRuntimeObject(ctx, c, obj); err != nil {
			return err
		}
	}
