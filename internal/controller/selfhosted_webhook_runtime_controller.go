...
func ensureRemoteRole(ctx context.Context, c client.Client, namespace string) (controllerutil.OperationResult, error) {
...
func ensureRemoteRoleBinding(ctx context.Context, c client.Client, namespace string) (controllerutil.OperationResult, error) {
