...
// SetupSelfHostedRoleEnqueueController registers the annotated remote
// ServiceAccount delete enqueue controller.
func SetupSelfHostedRoleEnqueueController(
	...
	if err := mcbuilder.ControllerManagedBy(mcMgr).
		...
		Complete(&SelfHostedRoleEnqueueController{
