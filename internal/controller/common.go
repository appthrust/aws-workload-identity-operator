...
func ensureFinalizer(ctx context.Context, c client.Client, recorder events.EventRecorder, log logr.Logger, obj client.Object, finalizer string) (bool, error) {
	if !obj.GetDeletionTimestamp().IsZero() || !controllerutil.AddFinalizer(obj, finalizer) {
		return false, nil
	}
	...
	log.Info("finalizer added", "awio.operation", "add_finalizer")
...
func requestsForList(ctx context.Context, c client.Reader, list client.ObjectList, opts ...client.ListOption) []reconcile.Request {
