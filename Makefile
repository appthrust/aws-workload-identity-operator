...
generate-crds:
	...
	cp config/crd/bases/aws.identity.appthrust.io_awsworkloadidentityconfigs.yaml charts/aws-workload-identity-operator/crds/aws.identity.appthrust.io_awsworkloadidentityconfigs.yaml
	cp config/crd/bases/aws.identity.appthrust.io_awsserviceaccountroles.yaml charts/aws-workload-identity-operator/crds/aws.identity.appthrust.io_awsserviceaccountroles.yaml
	cp config/crd/bases/aws.identity.appthrust.io_awsserviceaccountrolereplicasets.yaml charts/aws-workload-identity-operator/crds/aws.identity.appthrust.io_awsserviceaccountrolereplicasets.yaml
	cp config/crd/bases/aws.identity.appthrust.io_awsworkloadidentityoperatorconfigs.yaml charts/aws-workload-identity-operator/crds/aws.identity.appthrust.io_awsworkloadidentityoperatorconfigs.yaml

.PHONY: verify-generated
verify-generated: generate
	git diff --exit-code -- config/crd/bases charts/aws-workload-identity-operator/crds
...
test-version-sync:
	./hack/test-sync-chart-version.sh
