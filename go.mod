module github.com/appthrust/aws-workload-identity-operator

go 1.25.0

require (
	github.com/aws-controllers-k8s/eks-controller v1.13.0
	github.com/aws-controllers-k8s/iam-controller v1.6.3
	github.com/aws-controllers-k8s/runtime v0.58.1
	github.com/aws-controllers-k8s/s3-controller v1.3.4
