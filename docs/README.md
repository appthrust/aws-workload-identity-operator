...
| Choose a delivery type | [Delivery Types](concepts/delivery-types.md) |
| Understand the security boundaries | [Security Model](concepts/security-model.md) |

Delivery types include `SelfHostedIRSA`, `EKSIRSA`, and `EKSPodIdentity`.
...
| Copy a starting manifest | [Examples](examples/README.md) |
...
| Wire the IRSA sidecar into an OCM hosted add-on | [OCM Add-On Framework IRSA Sidecar](guides/ocm-addon-framework-token-file-sidecar.md) |

## Reference

| I want to... | Read |
| --- | --- |
| Check supported platform components | [Compatibility And Prerequisites](reference/compatibility.md) |
