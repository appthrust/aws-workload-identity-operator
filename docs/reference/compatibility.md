...
| ACK S3 controller | Required for `SelfHostedIRSA` | Owns the S3 Bucket and bucket policy CRs. The manager writes only discovery and JWKS objects with the AWS S3 API. |
