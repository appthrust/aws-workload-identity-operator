...
func parseFlags() managerOptions {
	...
	flag.BoolVar(&opts.leaderElect, "leader-elect", true, "Enable leader election for controller manager. Enabling this will ensure there is only one active controller manager.")
