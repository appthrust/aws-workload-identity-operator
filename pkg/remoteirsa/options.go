...
const (
	...
	// ServiceAccountRoleARNAnnotation is the aws-pod-identity-webhook
	// ServiceAccount annotation that carries the IAM role ARN.
	ServiceAccountRoleARNAnnotation = "eks.amazonaws.com/role-arn"
	// ServiceAccountAudienceAnnotation is the optional TokenRequest audience
	// annotation used by aws-pod-identity-webhook.
	ServiceAccountAudienceAnnotation = "eks.amazonaws.com/audience"
	// ServiceAccountRegionalSTSAnnotation requests regional STS endpoints when
	// set to "true".
	ServiceAccountRegionalSTSAnnotation = "eks.amazonaws.com/sts-regional-endpoints"
	// ServiceAccountTokenExpirationAnnotation is the optional TokenRequest
	// lifetime annotation in seconds.
	//nolint:gosec // Kubernetes annotation key contains "token" but is not credential material.
	ServiceAccountTokenExpirationAnnotation = "eks.amazonaws.com/token-expiration"
...
type Options struct {
	...
	// Optional namespaces used when resolving ClusterProfile objects by OCM
	// cluster-name label. Empty means all namespaces for backward
	// compatibility. Use "*" to explicitly request all namespaces.
...
func (o *Options) setDefaults() {
	...
	if o.RemoteConfigResolver == nil && o.HubReader != nil {
		o.RemoteConfigResolver = NewRemoteConfigResolverWithOptions(o.HubReader, RemoteConfigResolverOptions{
			ClusterProfileNamespaces: o.ClusterProfileNamespaces,
		})
	}
...
func (o *Options) validate() error { //nolint:cyclop // Validation is an explicit list of independent option guards.
	...
	case o.TokenExpiration > 0 && o.TokenExpiration < time.Second:
